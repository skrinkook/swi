        ...
        <nav className="navbar">
            <div className="nav-container">
                <div className="sub-container">
                    ...
                    <p className="circle-description">Zadanie údajov</p>
                </div>
                <div className="sub-container">
                    <div className="circle selected">
                        <h2 className="button-number selected-number">2</h2>
                    </div>
                ...
                <div className="sub-container">
                <div className="circle">
                <h2 className="button-number">4</h2>
                        </div>
                        <p className="circle-description">Zhrnutie rezervácie</p>
                </div>
            </div>
        </nav>
    )
